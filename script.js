...
function exportarPDF() {
  ...
  logo.onload = function () {
    ...
    try { doc.addImage(logo, "PNG", 40, 30, 60, 60); } catch {}
    ...
    tr.innerHTML = `
      ...
      <td>
        <select name="metodo[]" required>
          ...
          <option value="Alturadequeda">Altura de Queda mm 1000</option>
          <option value="Alturadequeda">Altura de Queda mm 500</option>
